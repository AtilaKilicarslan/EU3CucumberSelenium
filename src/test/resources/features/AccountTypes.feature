Feature: Account types
  ...
  Scenario Outline: Login with different accounts <userType>
    ...
    #<title> <-- basically means a loop of executions in one scenario.Scenario
    #Scenario outline is basicaly making our life easier by letting us give alot of data types like below listed.
    #and making us execute each line one by one like it is in a loop. but each data type has a <name> as you can see
    #above and below.
    Examples:
